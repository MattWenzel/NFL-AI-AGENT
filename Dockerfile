...
CMD ["/bin/sh", "-c", "mkdir -p /data/runtime /data/nflverse /data/exports && exec uvicorn backend.app.main:app --host 0.0.0.0 --port 8080 --proxy-headers --forwarded-allow-ips '*'"]
