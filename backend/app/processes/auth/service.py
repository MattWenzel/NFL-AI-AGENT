...
from backend.core.auth import email as email_sender
...
from backend.app.processes.auth.schemas import (
    AuthStatusResponse,
    AuthTokenResponse,
    AuthUser,
    RegistrationPendingResponse,
)
from backend.app.processes.auth.errors import (
    AuthConflictError,
...
from backend.core.auth.types import OAUTH_ONLY_SENTINEL_HASH, PASSWORD
from backend.app.bootstrap.audit import audit_log
from backend.app.processes.auth.types import AuditContext, IssuedSession, RegistrationResult
from backend.core.persistence import AuditEvent, RuntimeStore
    ...
    async def verify_email(
        ...
        *,
        ...
        async with self.store._async_session() as session:
            ...
            from backend.core.persistence.models import UserRecord
