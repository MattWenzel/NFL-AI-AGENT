...
from backend.core.auth.primitives import (
    CSRF_COOKIE_NAME,
    SESSION_COOKIE_NAME,
    _extract_session_token,
)
from backend.core.auth.types import AuthenticatedUser
from backend.core.config import EMAIL_VERIFICATION_REQUIRED
from backend.app.bootstrap.csrf import generate_csrf_token, verify_csrf
