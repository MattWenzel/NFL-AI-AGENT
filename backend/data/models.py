...
These classes are persistence models. Prefer explicit HTTP schemas in
`backend.api.schemas` when exposing data through FastAPI; a few legacy
responses still use record types where the row shape is already the wire
shape.
"""
