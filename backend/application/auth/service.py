...
from backend.domain.auth.primitives import hash_password, verify_password
...
class AuthService:
    ...
    async def auth_status(self, user: AuthenticatedUser | None) -> dict:
        return {
    ...
    async def verify_email(
        ...
        *,
        ...
        await self.store.mark_user_email_verified(user_id, now)
