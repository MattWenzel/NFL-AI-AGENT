...
`backend/application/oauth/codex.py::resolve_access_token`),
...
from backend.domain.auth.codex_oauth import decode_account_id
from backend.domain.auth.errors import CodexOAuthError
