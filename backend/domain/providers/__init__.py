...
def ensure_builtin_providers_registered() -> None:
    ...
    from backend.domain.providers.clients.anthropic import AnthropicClient  # noqa: E402
    ...
    try:
        from backend.domain.providers.clients.openai import OpenAIClient  # noqa: E402
        register_provider(ProviderInfo(
            name=OPENAI,
            display_name="OpenAI",
    ...
    from backend.domain.providers.clients.codex import OpenAICodexClient  # noqa: E402
