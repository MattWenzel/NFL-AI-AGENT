...
from core.auth import email as email_sender
...
from app.processes.auth.schemas import (
    AuthStatusResponse,
    AuthTokenResponse,
    AuthUser,
    RegistrationPendingResponse,
)
from app.processes.auth.errors import (
    AuthConflictError,
...
from core.auth.types import OAUTH_ONLY_SENTINEL_HASH, PASSWORD
from app.bootstrap.audit import audit_log
from app.processes.auth.types import AuditContext, IssuedSession, RegistrationResult
    ...
    async def verify_email(
        ...
        *,
        ...
        async with self.store._async_session() as session:
            ...
            from core.persistence.models import UserRecord
